...
class Buster(State):
	...
	def move_to_base(self):
		base = 0, 0 if not self.team else 16000, 9000
		d = distance(self.pos, base)
		debug(f'Move to base: {d}')
		if d > 1600:
			print('MOVE 0 0') if not self.team else print('MOVE 16000 9000')
			return False
		return True
	...
	def move_random(self):
		...
		pos = random.randrange(self.pos[0], 16000), random.randrange(0, 9000)
		print(f'MOVE {pos[0]} {pos[1]}')
